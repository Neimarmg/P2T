...
import Api.Dao.UsuariosBd.UsuarioDao;
 ...
 * @author neimarmoises
 */
public class tipoUtilitarioBd implements UsuarioDao {
    ...
    @Override
    public void salvar(TipoUtilitarios tipoUtilitario) {
        int id = 0;
        try {
            String sql = "INSERT INTO tipoutilitario(codTipoUtilitario, descTipoUtilitario) "
                    + "VALUES (?,?)";

            //Foi criado um novo método conectar para obter o id
            conectarObtendoId(sql);
            comando.setString(1, tipoUtilitario.getDescTipoUtilitario());
            ...
            if (resultado.next()) {
                ...
                tipoUtilitario.setCodTipoUtilitario(id);
            }
            else{
